...
def update_worksheet(data, worksheet):
    """
    Update given worksheet, add new row with the list data provided.
    """
...
def calculate_surplus(sales_row):
    ...
    The surplus is defined at the sales figure subtracted from the stock:
...
def get_stock_values(data):
    ...
    stock_dict = {}
    for heading, number in zip(headings, data):
        stock_dict.update({heading: number})
